...
<form action="<?php echo base_url('SuratPengantar/store'); ?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type="text" name="klasifikasi" id="klasifikasi" />
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type="text" name="lampiran" id="lampiran" />
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input style="background-color: white!important;" class="form-control" type="text" name="di" id="di" />
                    ...
                    <td>
                        <select class="form-control" name="id_jenissurat" id="id_jenissurat">
                            <?php foreach ($jenissurats as $data) : ?>
                                <option value="<?= $data['id_jenissurat']; ?>" <?php if ($data['id_jenissurat'] == 24) {
                                                                                    echo 'selected';
