        ...
        <table class="table table-striped">
            <tbody>
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?php echo htmlentities($suratbiasa['no_surat'], ENT_QUOTES); ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?php echo htmlentities($suratbiasa['tujuan_surat'], ENT_QUOTES); ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?= date('d-m-Y', strtotime($suratbiasa['tanggal_surat'])) ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?= date('d-m-Y', strtotime($suratbiasa['tanggal_dikirim'])) ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?= $suratbiasa['nama_jenissurat']; ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?php echo htmlentities($suratbiasa['perihal'], ENT_QUOTES); ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <span><?php echo htmlentities($suratbiasa['lampiran'], ENT_QUOTES); ?></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <?php if (!$suratbiasa['file'] == '') : ?>
                            <?php $random = rand(10, 100); ?>
                            <a href="<?= base_url() . '/uploads/keluar/' . $suratbiasa['file'] . '?t=' . $random; ?>" target="_blank" rel="noopener noreferrer">Lihat File</a>
                        <?php endif; ?>
                    </td>
                </tr>
