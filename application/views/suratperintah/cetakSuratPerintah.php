...
<table width="100%">
    ...
    <tr>
        ...
        <td>
            <center>
                <subkop> Nomor : <?php echo $suratperintah['no_surat'] ?> </subkop>
            </center>
        </td>
        <td width="15%">
        </td>
...
<table width="100%">
    <tr>
        ...
        <td width="">
            <p><?php echo $suratperintah['pertimbangan'] ?></p>
        </td>
    </tr>
    <tr>
        <td width="50px" style="vertical-align: top;">
        ...
        <td width="">
            <p><?php echo $suratperintah['dasar'] ?></p>
        </td>
    </tr>
    <tr>
        <td width="50px" style="vertical-align: top;">
        ...
        <td width="">
            <p style="margin: 0px;"><?php echo $suratperintah['kepada'] ?></p>
        </td>
    </tr>
    <tr>
        <td width="50px" style="vertical-align: top;">
        ...
        <td width="" style="vertical-align: top;">
            <p><?php echo $suratperintah['untuk'] ?></p>
        </td>
    </tr>
    <tr>
        <td width="50px" style="vertical-align: top;">
...
<table width="100%">
        ...
        <td width="">
            <table>
                <tr>
                    ...
                    <td>:</td>
                    <td><?php echo $suratperintah['kota'] ?></td>
                </tr>
                <tr>
                    <td>pada tanggal</td>
                    <td>:</td>
                    <td><?php echo date('d-M-Y', strtotime($suratperintah['tanggal'])) ?></td>
                </tr>
            </table>
    ...
    <tr>
        ...
        <td width="">
            <center>
                <p style="margin: 0px;"><?php echo $suratperintah['an'] ?></p>
            </center>
            <center>
                <p style="margin: 0px;"><?php echo $suratperintah['jabatan'] ?></p>
            </center>
        </td>
    </tr>
    <tr>
        ...
        <td width="">
            ...
            ?>
            <center>
                <?php if ($suratperintah['qrcode'] == '') : ?>
                    <br><br><br>
                <?php else : ?>
                    <img style="width: 100px;" src="<?php echo base_url() . 'assets/qrcode/' . $suratperintah['qrcode'] ?>">
                <?php endif; ?>
            </center>
        </td>
    </tr>
    <tr>
        ...
        <td width="">
            <center>
                <p><?php echo $suratperintah['nama_pejabat'] ?></p>
            </center>
        </td>
    </tr>
    <tr>
        ...
        <td width="">
            <center>
                <div style="border-top: 1px solid black;width:fit-content;">
                    <p style="margin: 0px;"><?php echo $suratperintah['nrp'] ?></p>
                </div>
            </center>
        </td>
    </tr>
