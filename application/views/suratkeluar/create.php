...
<form action="<?php echo base_url('SuratKeluar/store'); ?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type="number" name="no_agenda" id="no_agenda" value="<?php echo htmlentities(set_value('no_agenda'), ENT_QUOTES); ?>">
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type="text" name="tujuan_surat" id="tujuan_surat" value="<?php echo htmlentities(set_value('tujuan_surat'), ENT_QUOTES); ?>">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" class="form-control" class="ml-1" autocomplete="off" id="tanggal_dikirim" name="tanggal_dikirim" width="276" value="<?= set_value('tanggal_dikirim') ?>" />
