        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Hapus Data Jenis Surat</h5>
...
<div class="row d-flex justify-content-between">
    <div class=" col-sm-12 col-md-4">
        <div class="input-group mb-3">
            <form class="search-form d-flex align-items-center" action="<?php echo base_url('JenisSurat'); ?>" method="get">
    ...
    <div class="col-sm-12 col-md-4 d-flex flex-row-reverse">
        <a style="height:70%" href="<?= base_url('JenisSurat/create'); ?>" target="_self" class="btn btn-primary" rel="noopener noreferrer">TAMBAH</a>
    </div>
</div>
...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tbody>
            <?php foreach ($jenissurats as $key => $data) :  ?>
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                            ...
                            <a onclick="javascript:hapusjenissurat('<?php echo $data['id_jenissurat'] ?>','<?php echo $data['nama_jenissurat'] ?>')" type="button" data-bs-toggle="modal" data-bs-target="#basicModal" class="btn bg-gradient bg-danger"><i class="bi bi-trash text-white"></i></a>
                        </div>
                    </td>
                </tr>
...
<script>
    function hapusjenissurat(id, name) {
        // alert(id);
        // alert(name);
