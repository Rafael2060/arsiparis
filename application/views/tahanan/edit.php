...
<form action="<?= base_url('Tahanan/update') ?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type=" text" name="nama_tahanan" id="nama_tahanan" value="<?= $tahanan['nama_tahanan'] ?>">
                        <input type="hidden" name="id_tahanan" value="<?= $tahanan['id_tahanan']; ?>">
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type="text" name="ktp" id="ktp" value="<?= $tahanan['ktp'] ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-select" name="jk" id="jk">
                            <option value="L" <?php if ($tahanan['jk'] == 'L') {
                                                    echo 'selected';
                                                } ?>>Laki-Laki</option>
                            <option value="P" <?php if ($tahanan['jk'] == 'P') {
                                                    echo 'selected';
                                                } ?>>Perempuan</option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input class="form-control" class="ml-1" autocomplete="off" id="tanggal_lahir" name="tanggal_lahir" width="276" value="<?= $tanggal_lahir ?>" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input class="form-control" class="ml-1" autocomplete="off" id="tanggal_masuk" name="tanggal_masuk" width="276" value="<?= $tanggal_masuk ?>" />
                    ...
                    <td>
                        <select class="form-control" name="id_kategori" id="id_kategori">
                            <?php foreach ($kategoritahanans as $data) : ?>
                                <option <?php if ($data['id_kategori'] == $tahanan['id_kategori']) {
                                            echo 'selected';
                ...
                <tr>
                    ...
                    <td style="width:5%">:</td>
                    <td>
                        <input class="form-control" type=" text" name="alamat" id="alamat" value="<?= $tahanan['alamat']; ?>">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="umur" name="umur" value="<?= $tahanan['umur']; ?>">
                    ...
                    <td>
                        <select class="form-control" name="id_pekerjaan" id="id_pekerjaan">
                            <?php foreach ($pekerjaans as $data) : ?>
                                <option <?php if ($data['id_pekerjaan'] == $tahanan['id_pekerjaan']) {
                                            echo 'selected';
                                        } ?> value="<?= $data['id_pekerjaan']; ?>"><?= $data['nama_pekerjaan']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </td>
                </tr>
                    ...
                    <td>
                        <select class="form-control" name="id_agama" id="id_agama">
                            <?php foreach ($agamas as $data) : ?>
                                <option <?php if ($data['id_agama'] == $tahanan['id_agama']) {
                                            echo 'selected';
                                        } ?> value="<?= $data['id_agama']; ?>"><?= $data['nama_agama']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </td>
                </tr>
