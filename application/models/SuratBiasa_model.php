 ...
 * summary
 */
class SuratBiasa_Model extends CI_Model
{
    /**
     * summary
     */
    ...
    public function show($id)
    {
        ...
        return $this->db->where('id_suratbiasa', $id)->get('suratbiasa')->row_array();
    }
    ...
    public function showFromQRCode($id)
    {
        $this->db->select('*');
        $this->db->join('jenissurat', 'on jenissurat.id_jenissurat = suratbiasa.id_jenissurat');
        return $this->db->where('qrcode', $id)->get('suratbiasa')->row_array();
    }
    ...
    public function suratbiasa($no_surat = null, $tanggal_awal = null, $tanggal_akhir = null, $id_jenissurat = null, $limit = null, $offset = null)
    {
        ...
        $this->db->order_by('suratbiasa.tanggal', 'desc');
        $this->db->limit($limit);
        $this->db->offset($offset);
        return $this->db->get('suratbiasa')->result_array();
    }

    public function cetaksuratbiasa($id)
    {
        $this->db->select('suratbiasa.*, 
        jenissurat.nama_jenissurat, jenissurat.tipe');
        $this->db->join('jenissurat', 'on jenissurat.id_jenissurat = suratbiasa.id_jenissurat');
        $this->db->where('id_suratbiasa', $id);
    ...
    {
        $this->db->insert('suratbiasa', $data);
        return $this->db->insert_id('id_suratbiasa');
    }

    public function update($id, $data)
    {
        $this->db->where('id_suratbiasa', $id);
        return $this->db->update('suratbiasa', $data);
    }
