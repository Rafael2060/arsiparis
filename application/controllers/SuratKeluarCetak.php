...
class SuratKeluarCetak extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url']             = base_url('SuratKeluar/?') . 'no_surat=' . $no_surat . '&tanggal' . $tanggal . '&id_jenissurat=' . $id_jenissurat;
        $config['total_rows']           = $this->SuratKeluarCetak_model->total($no_surat, $tanggal, $id_jenissurat);
        ...
        $data['suratkeluarcetaks']  = $this->SuratKeluarCetak_model->suratkeluarcetak($no_surat, $tanggal, $id_jenissurat, $config['per_page'], $offset);
        ...
        $data['title']              = 'Surat Keluar - Cetak';
        $data['total']              = $config['total_rows'];
        $data['role_id']            = $this->session->userdata('role_id');

        $this->load->view('admin/header', $data);
        $this->load->view('suratkeluarcetak/suratkeluarcetak');
